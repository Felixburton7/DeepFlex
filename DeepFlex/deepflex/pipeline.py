# /home/s_felix/DeepFlex/deepflex/pipeline.py

"""
Main pipeline orchestration for the DeepFlex ML workflow.
...
from deepflex.models.neural_network import NeuralNetworkModel
from deepflex.models.random_forest import RandomForestModel
from deepflex.models.lightgbm_model import LightGBMModel
from deepflex.models.lightgbm_classifier import LightGBMClassifier
...
from deepflex.utils.helpers import progress_bar, ProgressCallback, ensure_dir
from deepflex.models import get_model_class, BaseModel # Import BaseModel for type hint
...
from deepflex.utils.metrics import evaluate_predictions
# Import visualization functions that will be added/adapted
from deepflex.utils.visualization import (
...
class Pipeline:
    """
    Main pipeline orchestration for DeepFlex.
