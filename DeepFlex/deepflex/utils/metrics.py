# deepflex/utils/metrics.py

"""
Evaluation metrics for the DeepFlex ML pipeline.
...
# from deepflex.data.processor import prepare_data_for_model
# from deepflex.utils.helpers import progress_bar
...
# The version below is adapted but might require further testing in the DeepFlex context.
...
# --- Other Utility Functions (Review for DeepFlex context) ---
...
# Note: This function is likely obsolete for DeepFlex as it assumes rmsf_{temp} columns
def calculate_temperature_scaling_factors(
    ...
    in the standard DeepFlex aggregated data. Could be adapted to work on the
    ...
    """
    logger.warning("calculate_temperature_scaling_factors is likely obsolete or needs refactoring for DeepFlex.")
