# /home/s_felix/DeepFlex/deepflex/temperature/comparison.py
"""
Temperature Analysis Utilities for DeepFlex.

NOTE: This module has been significantly simplified from its FlexSeq counterpart.
The core DeepFlex analysis now focuses on the single, temperature-aware model's
performance and sensitivity to the 'temperature' input feature, primarily handled
within the main pipeline analysis step and visualization utilities.
Functions comparing results across separate temperature *runs* are obsolete.
"""
...
logger.info("DeepFlex temperature.comparison module loaded (simplified version).")